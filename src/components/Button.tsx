...
export default function Button({ 
  ...
  const variantStyles = {
    default: "w-52 md:w-56 h-12 rounded-full text-base font-semibold hover:bg-hover bg-button text-white",
    small: "px-4 py-2 rounded-full text-xs font-bold hover:bg-hover bg-button text-white hidden md:inline-flex",
    xsmall: "px-3 py-1 rounded-full text-[10px] font-bold hover:bg-hover bg-button text-white md:hidden",
