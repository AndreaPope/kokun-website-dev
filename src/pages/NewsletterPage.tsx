          ...
          <div className="flex justify-center w-full mt-24">
            <div className="w-[1050px] bg-black/60 backdrop-blur-sm p-12 rounded-lg">
              <div className="space-y-8 text-xl">
                <p>
                  Join the Kōkūn Collective and help us transform how migraine and other invisible conditions are seen, understood, and healed. Stay informed about breakthroughs and developments in our community.
                </p>
