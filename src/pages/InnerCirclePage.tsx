        ...
        <main className="min-h-screen px-4 pb-24 pt-64 md:pt-72">
          <PageContentWrapper className="mb-48 md:mb-64">
            ...
            <div className="text-3xl sm:text-4xl md:text-6xl text-center font-bold mb-24 md:mb-32">
              <p className="flex items-center justify-center">
                <span>Help <span className="text-primary">Build What's Next</span></span>
              </p>
            </div>
          </PageContentWrapper>
          ...
          <PageContentWrapper className="bg-background backdrop-blur-sm p-6 md:p-12 rounded-lg">
            <div className="space-y-8 text-lg md:text-xl">
              ...
              <p>
                As a member of this group, you'll have the opportunity to use our migraine offering prior to public release and influence how it evolves from first impression to final detail.
              </p>
              <p>
                Interested? Fill out this short survey. It will help us understand your journey with migraine (and also ensure that we are building a group that reflects a range of voices and experiences). 
              </p>
              ...
              <form onSubmit={handleSubmit} className="mt-12 space-y-12">
                <div className="space-y-6">
                  <h2 className="text-xl font-bold font-sans text-primary">(1) Tell us about yourself​. We'd love to get to know you a little better.</h2>
                ...
                <div className="space-y-6">
                  <h2 className="text-xl font-bold font-sans text-primary">(2) We all experience migraine differently. Could you tell us a little bit about how you experience migraine​?</h2>
                ...
                <div className="space-y-6">
                  <h2 className="text-xl font-bold font-sans text-primary">(3) Our health conditions are often interconnected. Could you tell us if you experience any other health conditions?</h2>
                ...
                <div className="space-y-6">
                  <h2 className="text-xl font-bold font-sans text-primary">(4) What do you hope to get by being a part of the Kōkūn Inner Circle?</h2>
                  <div>
                    <textarea
                      id="hopes"
                      rows={4}
                ...
                <div className="space-y-6">
                  <h2 className="text-xl font-bold font-sans text-primary">(5) Is there anything else you'd like to share?</h2>
                  <div>
                    <textarea
                      id="additionalInfo"
                      rows={4}
