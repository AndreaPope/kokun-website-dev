  ...
  return (
    <div className="relative min-h-screen font-sans text-white">
      ...
      <div className="relative z-10">
        <header className="fixed top-0 left-0 right-0 z-50 bg-black/30 backdrop-blur-sm">
          <nav className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
            <div className="flex items-center space-x-8">
              <Link to="/" className="text-terracotta text-xl font-bold hover:text-terracotta-light transition-colors">Home</Link>
              <Link to="/migraine" className="text-terracotta font-bold hover:text-terracotta-light transition-colors">Migraine</Link>
              <Link to="/alt" className="text-terracotta font-bold hover:text-terracotta-light transition-colors">Alt</Link>
              <Link to="/home-alt" className="text-terracotta font-bold hover:text-terracotta-light transition-colors">Home Alt</Link>
            </div>
            <h1 className="text-3xl md:text-4xl font-bold absolute left-1/2 -translate-x-1/2">
              Kōkūn
            </h1>
            <div className="flex items-center space-x-8">
              <Link to="/about" className="text-terracotta font-bold hover:text-terracotta-light transition-colors">About Us</Link>
              <Link to="/early-access" className="text-terracotta font-bold hover:text-terracotta-light transition-colors">Join Us</Link>
            </div>
          </nav>
        </header>
        ...
        <section className="bg-black/50 backdrop-blur-sm py-20">
          <div className="max-w-6xl mx-auto px-4">
        ...
        <section className="bg-black/30 backdrop-blur-sm py-20">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <blockquote className="max-w-2xl mx-auto italic text-xl text-center relative px-12">
              <div className="quote-mark relative text-terracotta">
