      ...
      <div className="relative z-10">
        ...
        <main className="min-h-screen px-4 pb-24 pt-40 md:pt-48">
          <div className="max-w-4xl mx-auto w-full">
            <div className="font-display text-5xl sm:text-6xl md:text-8xl font-bold text-center leading-tight mb-12 md:mb-24">
            ...
            <div className="text-xl sm:text-2xl md:text-3xl text-center font-bold mb-12 md:mb-16" style={{ textShadow: '1px 1px 1px rgba(155, 155, 155, 0.4)' }}>
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center mb-48 md:mb-64">
          ...
          <section className="w-full flex justify-center mt-24">
            <div className="w-full md:w-[1050px] bg-black/60 backdrop-blur-sm p-6 md:p-12 rounded-lg">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-8 text-terracotta">We see what is unseen</h2>
          ...
          <section className="w-full flex justify-center mt-12">
            <div className="w-full md:w-[1050px] bg-black/60 backdrop-blur-sm p-6 md:p-12 rounded-lg">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-8 text-terracotta">We transform lived experiences into breakthroughs</h2>
              ...
              <div className="space-y-8 text-lg md:text-xl">
                ...
                <p>
                  To make that vision real, we're focused on two things: supporting you wherever you are in your journey, and surfacing insights that can transform our healing journeys.
                </p>

                <div>
                  <h3 className="text-xl md:text-2xl font-bold mb-2">Personalized Support</h3>
                  <p className="mb-6">
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold mb-2">Breakthrough Insights</h3>
                  <p className="mb-6">
                  ...
                  <p>
                    We're building the connective tissue – across patients, researchers and providers – to power this transformation.
                  </p>
                </div>
