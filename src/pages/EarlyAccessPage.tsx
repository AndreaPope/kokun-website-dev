          ...
          <div className="flex justify-center w-full mt-24">
            <div className="w-[1050px] bg-black/60 backdrop-blur-sm p-12 rounded-lg">
              <div className="space-y-8 text-xl">
                <p>
                  Join the Kōkūn Collective and help us transform how migraine and other invisible conditions are seen, understood, and healed. Together, let's bring to light what medicine has kept in the shadows for too long.
                </p>
                
                <p>
                  We're launching our beta soon and are looking for founding members who want to shape the Kōkūn Collective and the future of care for invisible conditions. Your experiences and insights will be instrumental in creating a platform that truly serves the needs of our community.
                </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <label className="flex items-start space-x-3">
                      ...
                      <span className="text-base">
                        Sign up for our newsletter to stay updated on invisible conditions and Kōkūn's progress
                      </span>
                    </label>
                    <label className="flex items-start space-x-3">
                      <input
                      ...
                      />
                      <span className="text-base">
                        Pledge to Kōkūn and help ignite change for the unseen millions
                      </span>
                    </label>
                  </div>
